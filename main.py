...
async def vote(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("🗳️ Vote system coming next update")
...
async def status(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("👥 Alive players:\n" + "\n".join(alive))
...
async def anti_forward(update: Update, context: ContextTypes.DEFAULT_TYPE):
    if update.message.forward_date:
        await update.message.reply_text("❌ Forwarded messages not allowed")
